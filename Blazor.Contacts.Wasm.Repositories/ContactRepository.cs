    ...
    public class ContactRepository:IContactRepository
    {
        ...
        public async Task<bool> InsertContact(Contact contact)
        {
            try
            {
                ...
                var result = await _dbConnection.ExecuteAsync(sql, new { contact.FirstName,contact.LastName,contact.Phone,contact.Address } );
        ...
        public async Task<bool> UpdateContact(Contact contact)
        {
            try
            {
                ...
                var result = await _dbConnection.ExecuteAsync(sql, new { contact.FirstName, contact.LastName, contact.Phone, contact.Address ,contact.Id });
